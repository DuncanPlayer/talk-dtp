...
public class SmsPushConst {
    ...
    public static final String SMS_NOTICE_TITLE = "talk_dtp_notice";

    public static final String SMS_ALARM_TITLE = "talk_dtp_alarm";

    public static final String SMS_CHANGE_NOTICE_TEMPLATE =
